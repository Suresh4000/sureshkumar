import { d as cn } from "./site-shell-VawXc1GZ.js";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/projects/mockups.tsx
function Frame({ title, children, className }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-border-strong" }),
				/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-border-strong" }),
				/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-border-strong" }),
				/* @__PURE__ */ jsx("span", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", { className: "mt-4 h-7 w-24 rounded-sm bg-inverse-fg/90" })
				]
			}), /* @__PURE__ */ jsxs("div", {
				className: "hidden space-y-3 bg-bg-elevated p-5 sm:block",
				children: [
					/* @__PURE__ */ jsx("div", { className: "h-2 w-24 rounded-sm bg-border" }),
					/* @__PURE__ */ jsx("div", { className: "h-2 w-full rounded-sm bg-border/80" }),
					/* @__PURE__ */ jsx("div", { className: "h-2 w-5/6 rounded-sm bg-border/80" }),
					/* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx(Frame, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", { className: "absolute top-1 bottom-1 left-[7px] w-px bg-border" }), [
					"Cochin arrival",
					"Munnar stay",
					"Alleppey houseboat",
					"Kovalam close"
				].map((stop, i) => /* @__PURE__ */ jsxs("div", {
					className: "relative flex items-center gap-3",
					children: [/* @__PURE__ */ jsx("span", { className: cn("absolute -left-4 size-2 rounded-full border border-border bg-bg-elevated", i === 1 && "bg-olive") }), /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsx(Frame, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", { className: "mt-4 h-16 rounded-md bg-bg-subtle" })
			]
		})
	});
}
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", { className: "h-8 w-28 rounded-sm bg-rust" }), /* @__PURE__ */ jsx("div", { className: "h-8 w-20 rounded-sm border border-inverse-fg/20" })]
				}),
				/* @__PURE__ */ jsx("div", { className: "absolute right-4 bottom-4 hidden h-20 w-20 rounded-full border border-inverse-fg/20 sm:block" })
			]
		})
	});
}
function ProjectMock({ id }) {
	switch (id) {
		case "garage-management": return /* @__PURE__ */ jsx(GarageMock, {});
		case "executive-consulting": return /* @__PURE__ */ jsx(ConsultingMock, {});
		case "travel-dashboard": return /* @__PURE__ */ jsx(TravelMock, {});
		case "corporate-tech": return /* @__PURE__ */ jsx(CorporateMock, {});
		case "fitness-landing": return /* @__PURE__ */ jsx(FitnessMock, {});
		default: return /* @__PURE__ */ jsx(GarageMock, {});
	}
}
//#endregion
