import { a as industries, c as projects, d as cn, l as skillGroups, n as additionalWork, o as processSteps, s as profile, t as SiteShell, u as stats } from "./site-shell-VawXc1GZ.js";
import { t as ProjectMock } from "./mockups-gzqCO1KR.js";
...
//#endregion
//#region src/components/home/contact-form.tsx
var schema = z.object({
	...
	return /* @__PURE__ */ jsxs("form", {
		...
		children: [
			...
			/* @__PURE__ */ jsx(Field, {
				...
				children: /* @__PURE__ */ jsx(Textarea, { ...form.register("message") })
			}),
			/* @__PURE__ */ jsx(Button, {
				type: "submit",
...
//#endregion
//#region src/components/home/home-page.tsx
var accentText = {
	ink: "text-fg",
	slate: "text-accent",
	stone: "text-stone",
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "paper-grid pointer-events-none absolute inset-0 opacity-60" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("a", {
							...
							children: ["View work", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
						}), /* @__PURE__ */ jsx("a", {
				...
				children: stats.map((stat) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: projects.map((project, index) => /* @__PURE__ */ jsxs(Link, {
						to: "/projects/$slug",
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(ProjectMock, { id: project.id })
						}), /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("ul", {
									...
									children: project.bullets.slice(0, 4).map((item) => /* @__PURE__ */ jsxs("li", {
										className: "flex gap-2",
										children: [/* @__PURE__ */ jsx("span", { className: "mt-2 size-1 shrink-0 rounded-full bg-border-strong" }), item]
									}, item))
								}),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsxs("span", {
									...
									children: ["Read case study", /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-4 transition-transform duration-150 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })]
								})
							]
						})]
					}, project.id))
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						children: additionalWork.map((item) => /* @__PURE__ */ jsxs("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("ol", {
					...
					children: processSteps.map((step) => /* @__PURE__ */ jsxs("li", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: industries.map((industry) => /* @__PURE__ */ jsx("span", {
				...
				children: skillGroups.map((group) => /* @__PURE__ */ jsxs("div", {
...
function Home() {
	return /* @__PURE__ */ jsx(SiteShell, { children: /* @__PURE__ */ jsx(HomePage, {}) });
}
//#endregion
