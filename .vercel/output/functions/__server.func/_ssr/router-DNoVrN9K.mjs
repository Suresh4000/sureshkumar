...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DNoVrN9K.js
...
function ThemeProvider({ children }) {
	...
	function toggle() {
		...
		window.localStorage.setItem("sk-theme", next);
	}
...
var styles_default = "/assets/styles-CWX8HNC5.css";
var APP_NAME = "Sureshkumar — Web Solutions Engineer";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Sureshkumar is a Web Solutions Engineer specializing in business websites, dashboards, and conversion-focused digital products."
			},
			{
				name: "theme-color",
				content: "#F3EFE6"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ThemeProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
				...
				toastOptions: { className: "font-[family-name:var(--font-sans)] bg-bg-elevated text-fg border-border" }
			})] }) }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Scripts, {})
		] })]
	})
});
var $$splitComponentImporter$1 = () => import("./routes-D9jt6TvA.mjs");
var Route$1 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitNotFoundComponentImporter = () => import("./projects._slug-SltMXY1m.mjs");
var $$splitComponentImporter = () => import("./projects._slug-BPZ5H5VB.mjs");
...
//#endregion
export { Route as n, useTheme as r, router_exports as t };
